...
const INVOICE_STRINGS = {
  en: { title: 'INVOICE', receiptTag: 'RECEIPT — PAID IN FULL', no: 'No.', date: 'Date', order: 'Order', paid: 'Paid', billTo: 'BILL TO', customer: 'Customer', description: 'DESCRIPTION', amount: 'AMOUNT', discount: 'Discount', subtotal: 'Subtotal (net)', vat: 'VAT', reverseChargeShort: 'reverse charge', total: 'Total', amountPaid: 'Amount paid', balanceDue: 'Balance due', paidInFull: 'PAID IN FULL', outsideEu: 'Sale outside the scope of EU VAT.', testBanner: 'TEST ORDER — NOT A VALID INVOICE', testNo: 'TEST — not a valid invoice', viesRef: 'VIES consultation no.', reverseChargeNote: 'Reverse charge — VAT to be accounted for by the recipient (Article 196 of Council Directive 2006/112/EC). Customer VAT: {vat}.' },
  da: { title: 'FAKTURA', receiptTag: 'KVITTERING — BETALT FULDT UD', no: 'Nr.', date: 'Dato', order: 'Ordre', paid: 'Betalt', billTo: 'FAKTURERES TIL', customer: 'Kunde', description: 'BESKRIVELSE', amount: 'BELØB', discount: 'Rabat', subtotal: 'Subtotal (netto)', vat: 'Moms', reverseChargeShort: 'omvendt betalingspligt', total: 'I alt', amountPaid: 'Betalt beløb', balanceDue: 'Skyldigt beløb', paidInFull: 'BETALT FULDT UD', outsideEu: 'Salg uden for EU’s momsområde.', testBanner: 'TESTORDRE — IKKE EN GYLDIG FAKTURA', testNo: 'TEST — ikke en gyldig faktura', viesRef: 'VIES-konsultationsnr.', reverseChargeNote: 'Omvendt betalingspligt — momsen afregnes af modtageren (artikel 196 i Rådets direktiv 2006/112/EF). Kundens momsnr.: {vat}.' },
  de: { title: 'RECHNUNG', receiptTag: 'QUITTUNG — VOLLSTÄNDIG BEZAHLT', no: 'Nr.', date: 'Datum', order: 'Bestellung', paid: 'Bezahlt', billTo: 'RECHNUNG AN', customer: 'Kunde', description: 'BESCHREIBUNG', amount: 'BETRAG', discount: 'Rabatt', subtotal: 'Zwischensumme (netto)', vat: 'USt.', reverseChargeShort: 'Reverse-Charge', total: 'Gesamt', amountPaid: 'Bezahlter Betrag', balanceDue: 'Offener Betrag', paidInFull: 'VOLLSTÄNDIG BEZAHLT', outsideEu: 'Verkauf außerhalb des Anwendungsbereichs der EU-USt.', testBanner: 'TESTBESTELLUNG — KEINE GÜLTIGE RECHNUNG', testNo: 'TEST — keine gültige Rechnung', viesRef: 'MIAS-Konsultationsnr.', reverseChargeNote: 'Steuerschuldnerschaft des Leistungsempfängers (Reverse-Charge) — die USt. schuldet der Empfänger (Artikel 196 der Richtlinie 2006/112/EG). USt-IdNr. des Kunden: {vat}.' },
  es: { title: 'FACTURA', receiptTag: 'RECIBO — PAGADO ÍNTEGRAMENTE', no: 'N.º', date: 'Fecha', order: 'Pedido', paid: 'Pagado', billTo: 'FACTURAR A', customer: 'Cliente', description: 'DESCRIPCIÓN', amount: 'IMPORTE', discount: 'Descuento', subtotal: 'Subtotal (neto)', vat: 'IVA', reverseChargeShort: 'inversión del sujeto pasivo', total: 'Total', amountPaid: 'Importe pagado', balanceDue: 'Saldo pendiente', paidInFull: 'PAGADO ÍNTEGRAMENTE', outsideEu: 'Venta fuera del ámbito del IVA de la UE.', testBanner: 'PEDIDO DE PRUEBA — NO ES UNA FACTURA VÁLIDA', testNo: 'PRUEBA — no es una factura válida', viesRef: 'N.º de consulta VIES', reverseChargeNote: 'Inversión del sujeto pasivo — el IVA debe ser liquidado por el destinatario (artículo 196 de la Directiva 2006/112/CE). NIF-IVA del cliente: {vat}.' },
  fr: { title: 'FACTURE', receiptTag: 'REÇU — PAYÉ INTÉGRALEMENT', no: 'N°', date: 'Date', order: 'Commande', paid: 'Payé', billTo: 'FACTURÉ À', customer: 'Client', description: 'DESCRIPTION', amount: 'MONTANT', discount: 'Remise', subtotal: 'Sous-total (net)', vat: 'TVA', reverseChargeShort: 'autoliquidation', total: 'Total', amountPaid: 'Montant payé', balanceDue: 'Solde dû', paidInFull: 'PAYÉ INTÉGRALEMENT', outsideEu: 'Vente hors du champ d’application de la TVA de l’UE.', testBanner: 'COMMANDE DE TEST — FACTURE NON VALIDE', testNo: 'TEST — facture non valide', viesRef: 'N° de consultation VIES', reverseChargeNote: 'Autoliquidation — TVA due par le preneur (article 196 de la directive 2006/112/CE). N° de TVA du client : {vat}.' },
  it: { title: 'FATTURA', receiptTag: 'RICEVUTA — PAGATA PER INTERO', no: 'N.', date: 'Data', order: 'Ordine', paid: 'Pagato', billTo: 'FATTURARE A', customer: 'Cliente', description: 'DESCRIZIONE', amount: 'IMPORTO', discount: 'Sconto', subtotal: 'Subtotale (netto)', vat: 'IVA', reverseChargeShort: 'inversione contabile', total: 'Totale', amountPaid: 'Importo pagato', balanceDue: 'Saldo dovuto', paidInFull: 'PAGATA PER INTERO', outsideEu: 'Vendita fuori dal campo di applicazione dell’IVA UE.', testBanner: 'ORDINE DI PROVA — FATTURA NON VALIDA', testNo: 'PROVA — fattura non valida', viesRef: 'N. consultazione VIES', reverseChargeNote: 'Inversione contabile — IVA assolta dal destinatario (articolo 196 della direttiva 2006/112/CE). P.IVA del cliente: {vat}.' },
  nl: { title: 'FACTUUR', receiptTag: 'KWITANTIE — VOLLEDIG BETAALD', no: 'Nr.', date: 'Datum', order: 'Bestelling', paid: 'Betaald', billTo: 'FACTUREREN AAN', customer: 'Klant', description: 'OMSCHRIJVING', amount: 'BEDRAG', discount: 'Korting', subtotal: 'Subtotaal (netto)', vat: 'btw', reverseChargeShort: 'verlegd', total: 'Totaal', amountPaid: 'Betaald bedrag', balanceDue: 'Openstaand bedrag', paidInFull: 'VOLLEDIG BETAALD', outsideEu: 'Verkoop buiten het toepassingsgebied van de EU-btw.', testBanner: 'TESTBESTELLING — GEEN GELDIGE FACTUUR', testNo: 'TEST — geen geldige factuur', viesRef: 'VIES-raadplegingsnr.', reverseChargeNote: 'Btw verlegd — de btw wordt voldaan door de afnemer (artikel 196 van Richtlijn 2006/112/EG). Btw-nr. klant: {vat}.' },
  nb: { title: 'FAKTURA', receiptTag: 'KVITTERING — BETALT I SIN HELHET', no: 'Nr.', date: 'Dato', order: 'Ordre', paid: 'Betalt', billTo: 'FAKTURERES TIL', customer: 'Kunde', description: 'BESKRIVELSE', amount: 'BELØP', discount: 'Rabatt', subtotal: 'Delsum (netto)', vat: 'MVA', reverseChargeShort: 'omvendt avgiftsplikt', total: 'Totalt', amountPaid: 'Betalt beløp', balanceDue: 'Utestående beløp', paidInFull: 'BETALT I SIN HELHET', outsideEu: 'Salg utenfor EUs merverdiavgiftsområde.', testBanner: 'TESTORDRE — IKKE EN GYLDIG FAKTURA', testNo: 'TEST — ikke en gyldig faktura', viesRef: 'VIES-konsultasjonsnr.', reverseChargeNote: 'Omvendt avgiftsplikt — mva. skal beregnes av mottakeren (artikkel 196 i direktiv 2006/112/EF). Kundens mva-nr.: {vat}.' },
  pl: { title: 'FAKTURA', receiptTag: 'POTWIERDZENIE — OPŁACONO W CAŁOŚCI', no: 'Nr', date: 'Data', order: 'Zamówienie', paid: 'Opłacono', billTo: 'NABYWCA', customer: 'Klient', description: 'OPIS', amount: 'KWOTA', discount: 'Rabat', subtotal: 'Suma częściowa (netto)', vat: 'VAT', reverseChargeShort: 'odwrotne obciążenie', total: 'Razem', amountPaid: 'Kwota zapłacona', balanceDue: 'Pozostało do zapłaty', paidInFull: 'OPŁACONO W CAŁOŚCI', outsideEu: 'Sprzedaż poza zakresem VAT UE.', testBanner: 'ZAMÓWIENIE TESTOWE — NIEWAŻNA FAKTURA', testNo: 'TEST — nieważna faktura', viesRef: 'Nr potwierdzenia VIES', reverseChargeNote: 'Odwrotne obciążenie — VAT rozlicza nabywca (artykuł 196 dyrektywy 2006/112/WE). Nr VAT nabywcy: {vat}.' },
  pt: { title: 'FATURA', receiptTag: 'RECIBO — PAGO NA TOTALIDADE', no: 'N.º', date: 'Data', order: 'Encomenda', paid: 'Pago', billTo: 'FATURAR A', customer: 'Cliente', description: 'DESCRIÇÃO', amount: 'MONTANTE', discount: 'Desconto', subtotal: 'Subtotal (líquido)', vat: 'IVA', reverseChargeShort: 'autoliquidação', total: 'Total', amountPaid: 'Montante pago', balanceDue: 'Saldo em dívida', paidInFull: 'PAGO NA TOTALIDADE', outsideEu: 'Venda fora do âmbito do IVA da UE.', testBanner: 'ENCOMENDA DE TESTE — FATURA INVÁLIDA', testNo: 'TESTE — fatura inválida', viesRef: 'N.º de consulta VIES', reverseChargeNote: 'Autoliquidação — IVA devido pelo adquirente (artigo 196.º da Diretiva 2006/112/CE). N.º de IVA do cliente: {vat}.' },
  fi: { title: 'LASKU', receiptTag: 'KUITTI — MAKSETTU TÄYSIMÄÄRÄISESTI', no: 'Nro', date: 'Päivämäärä', order: 'Tilaus', paid: 'Maksettu', billTo: 'LASKUTETAAN', customer: 'Asiakas', description: 'KUVAUS', amount: 'MÄÄRÄ', discount: 'Alennus', subtotal: 'Välisumma (netto)', vat: 'ALV', reverseChargeShort: 'käännetty verovelvollisuus', total: 'Yhteensä', amountPaid: 'Maksettu määrä', balanceDue: 'Maksettavaa jäljellä', paidInFull: 'MAKSETTU TÄYSIMÄÄRÄISESTI', outsideEu: 'Myynti EU:n arvonlisäveron soveltamisalan ulkopuolella.', testBanner: 'TESTITILAUS — EI KELVOLLINEN LASKU', testNo: 'TESTI — ei kelvollinen lasku', viesRef: 'VIES-kyselynro', reverseChargeNote: 'Käännetty verovelvollisuus — arvonlisäveron tilittää ostaja (neuvoston direktiivin 2006/112/EY 196 artikla). Asiakkaan ALV-numero: {vat}.' },
  sv: { title: 'FAKTURA', receiptTag: 'KVITTO — TILL FULLO BETALD', no: 'Nr', date: 'Datum', order: 'Order', paid: 'Betald', billTo: 'FAKTURERAS TILL', customer: 'Kund', description: 'BESKRIVNING', amount: 'BELOPP', discount: 'Rabatt', subtotal: 'Delsumma (netto)', vat: 'Moms', reverseChargeShort: 'omvänd betalningsskyldighet', total: 'Totalt', amountPaid: 'Betalt belopp', balanceDue: 'Utestående belopp', paidInFull: 'TILL FULLO BETALD', outsideEu: 'Försäljning utanför EU:s momsområde.', testBanner: 'TESTORDER — INGEN GILTIG FAKTURA', testNo: 'TEST — ingen giltig faktura', viesRef: 'VIES-konsultationsnr.', reverseChargeNote: 'Omvänd betalningsskyldighet — momsen redovisas av köparen (artikel 196 i direktiv 2006/112/EG). Kundens momsnr: {vat}.' },
  ru: { title: 'СЧЁТ', receiptTag: 'КВИТАНЦИЯ — ОПЛАЧЕНО ПОЛНОСТЬЮ', no: '№', date: 'Дата', order: 'Заказ', paid: 'Оплачено', billTo: 'ПЛАТЕЛЬЩИК', customer: 'Клиент', description: 'ОПИСАНИЕ', amount: 'СУММА', discount: 'Скидка', subtotal: 'Промежуточный итог (нетто)', vat: 'НДС', reverseChargeShort: 'обратное начисление', total: 'Итого', amountPaid: 'Оплаченная сумма', balanceDue: 'Остаток к оплате', paidInFull: 'ОПЛАЧЕНО ПОЛНОСТЬЮ', outsideEu: 'Продажа вне сферы действия НДС ЕС.', testBanner: 'ТЕСТОВЫЙ ЗАКАЗ — НЕДЕЙСТВИТЕЛЬНЫЙ СЧЁТ', testNo: 'ТЕСТ — недействительный счёт', viesRef: 'Номер консультации VIES', reverseChargeNote: 'Обратное начисление — НДС уплачивается получателем (статья 196 Директивы 2006/112/ЕС). НДС клиента: {vat}.' },
  zh: { title: '发票', receiptTag: '收据 — 已全额付款', no: '编号', date: '日期', order: '订单', paid: '已付', billTo: '付款方', customer: '客户', description: '项目说明', amount: '金额', discount: '折扣', subtotal: '小计（净额）', vat: '增值税', reverseChargeShort: '反向征收', total: '合计', amountPaid: '已付金额', balanceDue: '应付余额', paidInFull: '已全额付款', outsideEu: '本次销售不属于欧盟增值税范围。', testBanner: '测试订单 — 非有效发票', testNo: '测试 — 非有效发票', viesRef: 'VIES 咨询编号', reverseChargeNote: '反向征收 — 增值税由接收方申报缴纳（理事会指令 2006/112/EC 第 196 条）。客户增值税号：{vat}。' },
  ja: { title: '請求書', receiptTag: '領収書 — 全額支払済み', no: '番号', date: '日付', order: '注文', paid: '支払', billTo: '請求先', customer: 'お客様', description: '内容', amount: '金額', discount: '割引', subtotal: '小計（税抜）', vat: '付加価値税', reverseChargeShort: 'リバースチャージ', total: '合計', amountPaid: '支払金額', balanceDue: '未払残高', paidInFull: '全額支払済み', outsideEu: 'EU の付加価値税の対象外の販売です。', testBanner: 'テスト注文 — 有効な請求書ではありません', testNo: 'テスト — 有効な請求書ではありません', viesRef: 'VIES 照会番号', reverseChargeNote: 'リバースチャージ — 付加価値税は受領者が申告・納付します（理事会指令 2006/112/EC 第196条）。お客様の VAT 番号：{vat}。' },
  ko: { title: '인보이스', receiptTag: '영수증 — 전액 결제 완료', no: '번호', date: '날짜', order: '주문', paid: '결제일', billTo: '청구 대상', customer: '고객', description: '내역', amount: '금액', discount: '할인', subtotal: '소계(공급가액)', vat: '부가가치세', reverseChargeShort: '대리납부', total: '합계', amountPaid: '결제 금액', balanceDue: '미결제 잔액', paidInFull: '전액 결제 완료', outsideEu: 'EU 부가가치세 적용 대상이 아닌 판매입니다.', testBanner: '테스트 주문 — 유효한 인보이스가 아님', testNo: '테스트 — 유효한 인보이스가 아님', viesRef: 'VIES 조회 번호', reverseChargeNote: '대리납부 — 부가가치세는 공급받는 자가 신고·납부합니다(이사회 지침 2006/112/EC 제196조). 고객 VAT 번호: {vat}.' },
}
...
export function buildInvoicePdf(grant, priceBySku) {
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.font(FB).fontSize(8).fillColor(GREEN).text(t.receiptTag, { align: 'right' })
      doc.font(FN).fontSize(9).fillColor(muted)
