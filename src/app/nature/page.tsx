...
const items: GalleryItem[] = [
  ...
  { type: 'single', src: `${B}/NT00002.webp`, alt: 'Australian Gull', w: 3200, h: 1800, fx: 50, fy: 30 },
  { type: 'pair', images: [
  ...
  { type: 'single', src: `${B}/NT00004.webp`, alt: 'King Swan',       w: 3200, h: 1800, fx: 65, fy: 33 },
  { type: 'single', src: `${B}/NT00012.webp`, alt: 'COVID Fisherman', w: 6000, h: 3375, fx: 52, fy: 78 },
  { type: 'single', src: `${B}/NT00007.webp`, alt: 'Royal King Stag', w: 3200, h: 1800, fx: 55, fy: 57 },
]
