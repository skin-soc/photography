...
export default function Home() {
  ...
  <div className="w-full flex justify-center">
    <h1 
  className="text-[15vw] md:text-[12vw] lg:text-[14vw] tracking-[0.2em] md:tracking-[0.3em] font-bold md:font-medium text-[#931020]"
  style={{ marginRight: '-0.3em', textShadow: '0 1px 3px rgba(0,0,0,0.9)' }}
>
  McEWAN
</h1>
  </div>
