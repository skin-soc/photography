...
const items: GalleryItem[] = [
  { type: 'single', src: `${B}/PP00004.webp`, alt: 'King Charles III', w: 3200, h: 1800 },
  { type: 'pair', images: [
  ...
  { type: 'single', src: `${B}/PP00003.webp`, alt: 'Distortion Punter', w: 3200, h: 1800 },
  { type: 'pair', images: [
    { src: `${B}/PP00011.webp`, alt: 'Aaron Vogelmann', w: 3122, h: 3122 },
    { src: `${B}/PP00009.webp`, alt: 'Anders Malmgren', w: 3200, h: 3200 },
  ]},
  { type: 'single', src: `${B}/PP00002.webp`, alt: 'Young Solomon Islanders', w: 3200, h: 2133 },
