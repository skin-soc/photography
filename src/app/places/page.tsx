...
const items: GalleryItem[] = [
  ...
  { type: 'single', src: `${B}/PL00001.webp`, alt: 'Københavns Domhus, Copenhagen', w: 3200, h: 1800, fx: 50, fy: 10 },
  { type: 'single', src: `${B}/PL00007.webp`, alt: 'ARC, Copenhagen',               w: 3200, h: 2400, fx: 55, fy: 50 },
  { type: 'pair', images: [
  ...
  { type: 'single', src: `${B}/PL00006.webp`, alt: 'The Kelpies, Scotland',         w: 3200, h: 1792, fx: 50, fy: 30 },
  { type: 'single', src: `${B}/PL00011.webp`, alt: 'The Hand, Brisbane, Australia', w: 3200, h: 1800, fx: 45, fy: 55 },
  { type: 'pair', images: [
  ...
  { type: 'single', src: `${B}/PL00015.webp`, alt: 'Notre Dame Cathedral, Paris', w: 3200, h: 1800, fx: 55, fy: 30 },
]
